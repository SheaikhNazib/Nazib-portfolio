...
const MainTitle = memo(() => (
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-5xl sm:text-3xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
...
const WORDS = ["Enthusiastic software developer", "Keen on Exploring Technology's Impact on Real Estate"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/SheaikhNazib" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/sheaikh-nazibur-rahman/" },
  { icon: Mail, link: "mailto:sheaikhnazib9@gmail.com" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  NSU (CSE) | Front-End Developer Proficient in React & Next.js | Skilled in Game & 3D Design
                </p>
