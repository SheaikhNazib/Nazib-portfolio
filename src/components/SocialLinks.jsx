...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/sheaikh-nazibur-rahman/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@sheaikh.nazib",
    icon: Instagram,
    url: "https://www.instagram.com/sheaikh.nazib/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@SheaikhNazib",
    icon: Github,
    url: "https://github.com/SheaikhNazib",
    color: "#ffffff",
